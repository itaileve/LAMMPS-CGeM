...
#in_exp=reduced_planck*lineshape_frequencies/(boltz*T)
#quantum_correction = in_exp / (1. - np.exp(-in_exp))
#quantum_correction = np.exp(+in_exp/2.0)
#quantum_correction = 2.0 / (1. + np.exp(-reduced_planck*lineshape_frequencies/(boltz*T)))
#quantum_correction = np.exp(-reduced_planck*lineshape_frequencies/(boltz*T))
