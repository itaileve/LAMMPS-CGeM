...
void Init_Force_Functions( control_params *control )
{
  ...
  //Interaction_Functions[2] = Dummy_Interaction; //empty
...
void Init_Forces_noQEq( reax_system *system, control_params *control,
  ...
  for( i = 0; i < system->N; ++i ) {
    ...
    type_i  = atom_i->type;
    //if (type_i < 0 || type_i == 12) continue; //CGeM
    if (type_i < 0 || strcmp(system->reax_param.sbp[type_i].name,"EL")==0 || strcmp(system->reax_param.sbp[type_i].name,"DU")==0)continue; // CGeM
    ...
    for( pj = start_i; pj < end_i; ++pj ) {
      ...
      if (flag) {
        type_j = atom_j->type;
	//if (type_j < 0 || type_j == 12) continue; //CGeM
	if (type_j < 0 || strcmp(system->reax_param.sbp[type_j].name,"EL")==0 || strcmp(system->reax_param.sbp[type_j].name,"DU")==0)continue; // CGeM
